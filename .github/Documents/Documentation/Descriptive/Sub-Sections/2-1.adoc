...
[.hl-green]#Events, actions, and behaviors describe the system’s dynamic elements during tournament operations. Based on the tournament flow described in the reference document, these elements can be categorized as follows:#
...
** [.hl-green]#Create a tournament.#
** Register a team for a tournament.
** [.hl-green]#Generate tournament bracket.#
** [.hl-green]#Assign a team captain.#
