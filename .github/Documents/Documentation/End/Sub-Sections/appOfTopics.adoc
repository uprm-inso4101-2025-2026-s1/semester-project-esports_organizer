...
•  Team Leaders: They coordinate weekly meetings, verify and approve issues before the
managers view them and are up to date with the achievements of every member on their
team.
•  Development Teams: Database and Backend, events and notifications, Profiles, social
features, and UI teams in charge of developing the frontend and backend tasks.#
