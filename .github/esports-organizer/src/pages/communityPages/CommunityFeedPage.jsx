...
const mockEvents = [
    {id: 1, title: "Marvel Rivals Tournament", date: "01 Oct 2025", price: "Free", location: "Online", game: "Marvel Rivals"},
    {id: 2, title: "Weekly Rivals Comp", date: "16 Oct 2025", price: "20$", location: "Online", game: "Marvel Rivals"},
];
...
const mockSidebarCommunities = {
    followed: [
        ...
        {id: 4, title: "League of Legends", imageUrl: "/assets/images/valorant.png"}
    ],
    top: [
        ...
        <form className="create-post-form" onSubmit={handleSubmit}>
            ...
            <div className="create-post-content">
                ...
                <div className="create-post-actions">
                    ...
                    <button type="submit" className="post-submit-btn" disabled={!postContent.trim()}>
                        Post
                    </button>
                </div>
            </div>
            ...
            <header className="nav-header">
                <div className="nav-container">
                    <div className="nav-left">
                        <div className="nav-logo" onClick={() => handleNavigation("/homepage")} role="button" tabIndex={0} >
                            <img src="/assets/images/LOGO.png" alt="Esport Organizer Logo" className="logo-image"/>
                        </div>
                        <nav className={`nav-menu ${isMobileMenuOpen ? "nav-menu-open" : ""}`}
                             aria-label="Main navigation">
                            {navItems.map((item) => (
                                <button key={item.path} className={`nav-link ${location.pathname === item.path ? "active" : ""}`} onClick={() => handleNavigation(item.path)}>
                                    {item.label}
                                </button>
                            ))}
                        </nav>
                    ...
                    <div className="nav-actions">
                        <Button text="Login/Sign Up" onClick={() => handleNavigation("/login")} variant="primary"
                        />
                        <button className="mobile-menu-toggle" onClick={toggleMobileMenu} aria-label="Toggle mobile menu" aria-expanded={isMobileMenuOpen}>
